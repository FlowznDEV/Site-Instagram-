    ...
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-[#b89047] selection:text-black ambient-bg relative overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <header className="py-8 flex justify-between items-center border-b border-zinc-900 mb-12 md:mb-16 print:hidden relative">
          ...
          <div className="flex items-center gap-3 cursor-pointer group" onClick={() => setIsAdminView(false)}>
            <div className="relative w-9 h-9 flex items-center justify-center border border-[#b89047]/60 group-hover:border-[#b89047] bg-black transition-colors duration-300">
              {/* Outer lines/accents for high aesthetic detail */}
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="text-[10px] font-mono text-zinc-400 hover:text-[#b89047] transition-colors uppercase tracking-[0.2em] flex items-center gap-1.5 border border-zinc-900 hover:border-[#b89047]/40 px-3.5 py-1.5 bg-zinc-950/40"
              id="admin-toggle-nav"
            >
              <Eye size={11} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start mb-28">
              ...
              >
                ...
                <motion.h1 
                  ...
                  className="text-3xl sm:text-4xl lg:text-[42px] font-display font-bold tracking-tight text-white uppercase leading-[1.2]"
                >
                ...
                <motion.div variants={itemVariants} className="space-y-5 text-zinc-400 text-sm md:text-base leading-relaxed font-sans font-light max-w-xl">
                  ...
                  <p className="border-l-2 border-[#b89047] pl-4 py-2 italic text-zinc-400 font-serif leading-relaxed bg-zinc-950/40 pr-3">
                    {renderHighlightedText(
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-3.5 pt-4">
                  <button
                    ...
                    className="bg-[#b89047] hover:bg-white text-black font-mono uppercase text-[11px] py-4.5 px-8 tracking-[0.2em] font-black transition-all rounded-none flex items-center justify-center gap-2.5 shadow-[0_0_25px_rgba(184,144,71,0.25)] hover:shadow-[0_0_35px_rgba(184,144,71,0.45)] active:scale-98 group animate-bounce-subtle"
                    id="hero-cta-btn"
                  >
            ...
            >
              ...
              <div className="max-w-3xl mx-auto space-y-6 text-center">
                ...
                <div className="pt-8">
                  <button
                    onClick={scrollToForm}
                    className="inline-flex items-center gap-2.5 px-8 py-4 px-6 rounded-none bg-white hover:bg-zinc-200 text-black font-mono uppercase text-xs tracking-[0.22em] font-bold transition-all duration-300"
                  >
        ...
        <div className="fixed bottom-6 right-6 z-50 print:hidden">
          ...
          >
            <motion.a
              href="https://wa.me/message/4575TYEYPEQLK1"
              target="_blank"
            ...
            >
              ...
              <div className="relative flex h-5 w-5 items-center justify-center">
                ...
                <svg 
                  viewBox="0 0 24 24" 
                  className="w-5 h-5 fill-current text-black group-hover:scale-110 transition-transform duration-300" 
